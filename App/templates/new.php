...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <?php endif; ?>
            <form id="new" action="#" role="form" method="post" data-parsley-validate='' enctype="multipart/form-data">
                <fieldset>
                    <legend>Новое сообщение</legend>
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" name="name" id="name"
                               value="<?= $_POST['name'] ? $_POST['name'] : '' ?>" data-parsley-trigger="change"
                               required="">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" class="form-control" name="email" id="email"
                               value="<?= $_POST['email'] ? $_POST['email'] : '' ?>" data-parsley-trigger="change"
                               required="">
                    </div>
